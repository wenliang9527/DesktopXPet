...
| 🌱 **养成系统** | 心情/饱食度/精力/亲密度四维属性、等级/经验值、离线衰减、喂食/摸头互动 |
...
| 属性 | 说明 | 衰减速率 |
|------|------|---------|
| 心情 (mood) | 受互动和饱食度影响 | 0.5/分钟 |
| 饱食度 (satiety) | 随时间下降，喂食恢复 | 0.5/分钟 |
| 精力 (energy) | 工作时消耗，睡眠时恢复 | 工作-0.3/分钟 |
| 亲密度 (intimacy) | 通过互动提升 | 不衰减 |

**互动方式：**
- 左键点击 — 跳跃动画 + 心情+3 / 亲密度+1（3秒冷却）
- 鼠标悬停1.5秒 — 摸头动画 + 心情+5 / 亲密度+2（3秒冷却）
- 右键喂食 — 吃饭动画 + 饱食度+20 / 心情+2 / 亲密度+1（3秒冷却）

**等级系统：** 完成工作任务、番茄钟、互动均可获得经验值，升级解锁更多互动。

> 详细说明请参阅 [养成系统指南](./docs/USAGE_NURTURE.md)
...
| [养成系统指南](./docs/USAGE_NURTURE.md) | 四维属性、互动方式、等级系统、番茄钟 |
