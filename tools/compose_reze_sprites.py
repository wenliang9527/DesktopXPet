#!/usr/bin/env python3
"""
Compose AI-generated sprite sheets for the "蕾塞" (Reze) skin from Chainsaw Man.
...
OUT_DIR = r'D:\WORK_VSCODE\Vibe-coding\DesktopXPet\resources\skins\reze'
...
STATES = [
    ('idle', [
        'reze-idle-a_1781774949.png',
        'reze-idle-b_1781774967.png',
    ], 6, 6, True),
    ('working', [
        'reze-working-a_1781774985.png',
        'reze-working-b_1781775004.png',
    ], 6, 10, True),
    ('happy', [
        'reze-happy-a_1781775023.png',
        'reze-happy-b_1781775071.png',
    ], 6, 8, True),
    ('sleeping', [
        'reze-sleeping-a_1781775090.png',
        'reze-sleeping-b_1781775109.png',
    ], 6, 3, True),
    ('error', [
        'reze-error-a_1781775129.png',
        'reze-error-b_1781775150.png',
    ], 6, 6, True),
]
...
def main():
    print("=" * 60)
    print("Composing Reze HD Sprite Sheets (12 frames, 384x384)")
    print("=" * 60)
    ...
    # Manifest
    manifest = {
        "name": "蕾塞 Reze (Chainsaw Man)",
        "author": "DesktopXPet",
        "version": "1.0.0",
        "preview": "preview.png",
        "description": "Chibi anime Reze from Chainsaw Man — bomb girl with red flower HD sprites",
    ...
    print("\n" + "=" * 60)
    print("Done! Reze HD skin generated.")
    print("=" * 60)
